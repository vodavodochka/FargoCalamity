...
namespace FargoCalamity.Calamity.Ammos.Arrows
{
    ...
    public class CinderQuiver : BaseAmmo
    {
        public override int AmmunitionID => ModLoader.GetMod("CalamityMod").Find<ModItem>("CinderArrow").Type;
    }
    ...
    {
        public override int AmmunitionID => ModLoader.GetMod("CalamityMod").Find<ModItem>("SproutingArrow").Type;
    }
    ...
    public class VeriumQuiver : BaseAmmo
    {
        public override int AmmunitionID => ModLoader.GetMod("CalamityMod").Find<ModItem>("VeriumBolt").Type;
    }
}
