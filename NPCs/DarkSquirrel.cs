...
namespace FargoCalamity.NPCs
{
    ...
    public class DarkSquirrel : ModNPC
    {
        ...
        private string ShopName1 = "DarkSquirrelShop";
        private string ShopName2 = "DarkSquirrelShop2";
        private int count;
        public NPCShop NpcShop1 { get; set; }
        public NPCShop NpcShop2 { get; set; }
        public bool shop2Active = false;
        ...
        public override void OnChatButtonClicked(bool firstButton, ref string shop)
        {
            ...
            {
                shop = ShopName2; //shop2Active ? ShopName1 : ShopName2;
                //if (ShopName.Equals(ShopName2)) shop2Active = true;
                //else shop2Active = false;
            }
        }

        public override void AddShops()
        {
            NpcShop1 = new NPCShop(Type, ShopName1);
            NpcShop2 = new NPCShop(Type, ShopName2);
